    ...
    >
      <OverlayArrow>
        <svg
          ...
          height={8}
          viewBox="0 0 8 8"
          className="group-placement-bottom:rotate-180 group-placement-left:-rotate-90 group-placement-right:rotate-90 fill-foreground stroke-foreground block forced-colors:fill-[Canvas] forced-colors:stroke-[ButtonBorder]"
        >
